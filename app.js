...
const UUID = process.env.UUID || 'a0b0b5c7-aead-4545-b01f-c924537d0778';
...
const NAME = process.env.NAME || 'Webhosting-Node';
...
httpServer.listen(port, '127.0.0.1', () => {  // 监听本地地址
    console.log(`HTTP Server is running on 127.0.0.1:${port}`);
});
